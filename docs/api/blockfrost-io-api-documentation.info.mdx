...
<span className={"theme-doc-version-badge badge badge--secondary"}>Version: 0.1.59</span>

<Export url={"https://github.com/blockfrost/blockfrost-backend-ryo/issues"} proxy={undefined}></Export>

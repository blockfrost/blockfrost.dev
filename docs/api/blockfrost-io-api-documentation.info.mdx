...
<span className={"theme-doc-version-badge badge badge--secondary"}>Version: 0.1.60</span>

<Export url={"https://raw.githubusercontent.com/blockfrost/openapi/daf40b1a88463bebd5d562bcabb18d5c001bf83e/openapi.yaml"} proxy={undefined}></Export>

<h1 className={"openapi__heading"}>Blockfrost.io ~ API Documentation</h1>

<ApiLogo logo={{"url":"https://staging.blockfrost.io/images/logo.svg","altText":"Blockfrost"}} darkLogo={undefined}></ApiLogo>
...
<div style={{"marginBottom":"2rem"}}><h2 id={"authentication"} style={{"marginBottom":"1rem"}}>Authentication</h2><SchemaTabs className={"openapi-tabs__security-schemes"}><TabItem label={"API Key: project_id"} value={"project_id"}>

                    ...
                    "schema":
                      {
                        ...
                        "title": "account_addresses_content",
                      },
                  },
              },
          },
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Obtain information about the addresses of a specific account.\n<b>Be careful</b>, as an account could be part of a mangled address and does not necessarily mean the addresses are owned by user as the account.\n",
            "type": "text/plain",
          },
        "url":
          {
...
<h1 className={"openapi__heading"}>Account associated addresses</h1>
...
<b>Be careful</b>, as an account could be part of a mangled address and does not
necessarily mean the addresses are owned by user as the account.

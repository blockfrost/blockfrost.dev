...
api:
  {
                    ...
                    "schema":
                      {
                        ...
                        "title": "account_delegation_content",
                      },
                  },
              },
          },
    ...
    "servers":
      [
        ...
        { "url": "https://localhost:3000", "description": "local" },
      ],
    "security": [{ "ApiKeyAuth": [] }],
    "securitySchemes":
      {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Obtain information about the delegation of a specific account.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "The number of results displayed on one page.",
                      "type": "text/plain",
                    },
                  "key": "count",
                  "value": "",
                },
                {
                  ...
                  "description":
                    {
                      "content": "The page number for listing the results.",
                      "type": "text/plain",
                    },
                  "key": "page",
                  "value": "",
                },
                {
                  ...
                  "description":
                    {
                      "content": "The ordering of items from the point of view of the blockchain,\nnot the page listing itself. By default, we return oldest first, newest last.\n",
                      "type": "text/plain",
                    },
                  "key": "order",
                  "value": "",
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) Bech32 stake address.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
...
<h1 className={"openapi__heading"}>Account delegation history</h1>
...
<SecuritySchemes
  infoPath={"./docs/api/blockfrost-io-api-documentation"}
></SecuritySchemes>
...
<details style={{"marginBottom":"1rem"}} className={"openapi-markdown__details"} data-collapsed={false} open={true}><summary style={{}}><h3 className={"openapi-markdown__details-summary-header-params"}>Path Parameters</h3></summary><div><ul><ParamsItem className={"paramsItem"} param={{"in":"path","name":"stake_address","required":true,"schema":{"type":"string"},"description":"Bech32 stake address.","example":"stake1u9ylzsgxaa6xctf4juup682ar3juj85n8tx3hthnljg47zctvm3rc"}}></ParamsItem></ul></div></details><details style={{"marginBottom":"1rem"}} className={"openapi-markdown__details"} data-collapsed={false} open={true}><summary style={{}}><h3 className={"openapi-markdown__details-summary-header-params"}>Query Parameters</h3></summary><div><ul><ParamsItem className={"paramsItem"} param={{"in":"query","name":"count","required":false,"schema":{"type":"integer","minimum":1,"maximum":100,"default":100},"description":"The number of results displayed on one page."}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"in":"query","name":"page","required":false,"schema":{"type":"integer","minimum":1,"maximum":21474836,"default":1},"description":"The page number for listing the results."}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"in":"query","name":"order","required":false,"schema":{"type":"string","enum":["asc","desc"],"default":"asc"},"description":"The ordering of items from the point of view of the blockchain,\nnot the page listing itself. By default, we return oldest first, newest last.\n"}}></ParamsItem></ul></div></details><div><div><ApiTabs><TabItem label={"200"} value={"200"}><div>

Return the account delegations content

</div><div><MimeTabs className={"openapi-tabs__mime"} schemaType={"response"}><TabItem label={"application/json"} value={"application/json"}><SchemaTabs className={"openapi-tabs__schema"}><TabItem label={"Schema"} value={"Schema"}><details style={{}} className={"openapi-markdown__details response"} data-collapsed={false} open={true}><summary style={{}} className={"openapi-markdown__details-summary-response"}><strong>Schema</strong></summary><div style={{"textAlign":"left","marginLeft":"1rem"}}></div><ul style={{"marginLeft":"1rem"}}><li><div style={{"fontSize":"var(--ifm-code-font-size)","opacity":"0.6","marginLeft":"-.5rem","paddingBottom":".5rem"}}>Array [</div></li><SchemaItem collapsible={false} name={"active_epoch"} required={true} schemaName={"integer"} qualifierMessage={undefined} schema={{"type":"integer","example":210,"description":"Epoch in which the delegation becomes active"}}></SchemaItem><SchemaItem collapsible={false} name={"tx_hash"} required={true} schemaName={"string"} qualifierMessage={undefined} schema={{"type":"string","description":"Hash of the transaction containing the delegation"}}></SchemaItem><SchemaItem collapsible={false} name={"amount"} required={true} schemaName={"string"} qualifierMessage={undefined} schema={{"type":"string","description":"Rewards for given epoch in Lovelaces"}}></SchemaItem><SchemaItem collapsible={false} name={"pool_id"} required={true} schemaName={"string"} qualifierMessage={undefined} schema={{"type":"string","description":"Bech32 ID of pool being delegated to"}}></SchemaItem><li><div style={{"fontSize":"var(--ifm-code-font-size)","opacity":"0.6","marginLeft":"-.5rem"}}>]</div></li></ul></details></TabItem><TabItem label={"Example (from schema)"} value={"Example (from schema)"}><ResponseSamples responseExample={"[\n  {\n    \"active_epoch\": 210,\n    \"tx_hash\": \"2dd15e0ef6e6a17841cb9541c27724072ce4d4b79b91e58432fbaa32d9572531\",\n    \"amount\": \"12695385\",\n    \"pool_id\": \"pool1pu5jlj4q9w9jlxeu370a3c9myx47md5j5m2str0naunn2q3lkdy\"\n  },\n  {\n    \"active_epoch\": 242,\n    \"tx_hash\": \"1a0570af966fb355a7160e4f82d5a80b8681b7955f5d44bec0dde628516157f0\",\n    \"amount\": \"12691385\",\n    \"pool_id\": \"pool1kchver88u3kygsak8wgll7htr8uxn5v35lfrsyy842nkscrzyvj\"\n  }\n]"} language={"json"}></ResponseSamples></TabItem></SchemaTabs></TabItem></MimeTabs></div></TabItem><TabItem label={"400"} value={"400"}><div>
